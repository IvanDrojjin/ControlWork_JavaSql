...
CREATE  OR REPLACE VIEW `все_животные1` AS --  собаки кошки хомячки; лошади ослы верблюды;  
SELECT id, имя, команды, дата_рождения, видId, 'собаки' AS таблица  FROM собаки
UNION  SELECT id, имя, команды, дата_рождения, видId, 'кошки' AS таблица  FROM кошки  
UNION  SELECT id, имя, команды, дата_рождения, видId, 'хомячки' AS таблица  FROM хомячки  
UNION  SELECT id, имя, команды, дата_рождения, видId, 'лошади' AS таблица  FROM лошади  
UNION  SELECT id, имя, команды, дата_рождения, видId, 'ослы' AS таблица  FROM ослы 
-- UNION  SELECT id, имя, команды, дата_рождения, видId, 'верблюды' AS таблица  FROM верблюды
;

SELECT * FROM Друзья_человека.все_животные1;
-- END SQL 	24.12.2023