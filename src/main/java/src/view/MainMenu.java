...
public class MainMenu {
    ...
    public MainMenu(ConsoleUI consoleUI) {
        ...
        commandList.add(new AnimalSearch(consoleUI));  // +++
        commandList.add(new GetAnimalsInfo(consoleUI));  // +++
        commandList.add(new SortByName(consoleUI));  // +++
        commandList.add(new SortByAge(consoleUI));  // +++
        commandList.add(new LoadAnimalsFromFile(consoleUI));  // +++
        commandList.add(new AppendAnimalsFromFile(consoleUI));  // +++
        commandList.add(new SaveAnimalsToFile(consoleUI));  // +++
